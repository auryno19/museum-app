...
@section('content')
    <div class="p-lg-3">
        <h3 class="mt-0 mb-2 font-weight-bold">Tambah Koleksi</h3>
                ...
                <div>
                    <div class="">
                        <div class="mb-3 row d-flex justify-content-center">
                            <label for="title_id">Judul koleksi dalam bahasa Indonesia</label>
                            <input class="form-control" type="text" placeholder="Isi judul" name="title_id"
                                value="{{ old('title_id') }}">
                            @error('title_id')
                        ...
                        <div class="mb-3 row d-flex justify-content-center">
                            <label for="title_eng">Judul koleksi dalam bahasa Inggris</label>
                            <input class="form-control" type="text" placeholder="Isi judul" name="title_eng"
                                value="{{ old('title_eng') }}">
                            @error('title_eng')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3 row d-flex justify-content-center">
                            <label for="desc_id">Deskripsi dalam bahasa Indonesia</label>
                            <textarea class="form-control" rows="3" name="desc_id" placeholder="isi deskripsi" value="{{ old('desc_id') }}"></textarea>
                            @error('desc_id')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3 row d-flex justify-content-center">
                            <label for="desc_eng">Deskripsi dalam bahasa Inggris</label>
                            <textarea class="form-control" rows="3" name="desc_eng" placeholder="isi deskripsi" value="{{ old('desc_eng') }}"></textarea>
                            @error('desc_eng')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
